<template> 
 <div class="block">   
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%; margin-top:20px">
			...
			<el-table-column prop="communityName" label="小区名称" width="300" sortable>
			</el-table-column>
			<el-table-column prop="communityNo" label="小区编号" width="250" sortable>
			</el-table-column>
			<el-table-column prop="sumcount" label="设备总数量" width="300" sortable>
			</el-table-column>
      	<el-table-column prop="totalcount" label="设备激活数量" width="300" sortable>
			</el-table-column>
...
<script>
	...
	loadData(){
		...
		RequestGet("/parameter/admin/findAll",this.page).then(response => {
						if(response.code == '0000'){
