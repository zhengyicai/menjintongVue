<template> 
 <div class="block" style="padding-top:10px">   
	 	...
	 	<el-col   v-if='adminshow==true' :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" style="text-align:left" >
				<el-form :inline="true">
				<el-form-item style="width:300px">
					<el-input v-model="page.criteria" @keyup.enter.native="query"   placeholder="请输入[小区编号|小区名称|物业员用户名]" style="width:300px"></el-input>
				</el-form-item>
				<el-form-item  >
		...
		<el-col  v-if='adminshow==false' :span="17" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" style="text-align:left" >
				<el-form :inline="true">
				<el-form-item style="width:300px">
					<el-input v-model="page.criteria" @keyup.enter.native="query"   placeholder="请输入[小区编号|小区名称|物业员用户名]" style="width:300px"></el-input>
	 	...
	 	<el-col v-if='adminshow==false' :span="7" class="toolbar" style="padding-bottom: 0px;">
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column label="操作" min-width="280">
				...
				<el-button size="small" type="danger" v-if="scope.row.userStatus==='10' ||  scope.row.userStatus==='20'" @click="deleteState(scope.row,'30')">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog   :title="formAdmintitle" :visible.sync="dialogFormAdminUpdateVisible" >
			<el-form ref="form1" :model="form1" label-width="100px" @submit.prevent="onSubmit" style="margin:20px;">
				...
				<el-form-item label="登录名">
					<el-input disabled="disabled"  placeholder="请输入用户名" v-model="form1.loginName"></el-input>
				</el-form-item>
	  ...
	  deleteState(rows,state){
           ...
           this.$confirm('确认该操作, 是否继续?', '提示', {
            ...
            type: 'warning'
                ...
                rows.state = state;
                RequestPost("/community/trueDelete",rows).then(response => {
